...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_PLANDAYEXERCICE = "";
    ...
    public static final String TABLE_PLANDAYEXERCICE = "PlanDayExercice";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE if not exists `" + TABLE_PLANDAYEXERCICE + "` (`" + COLUMN_ID + "` INTEGER PRIMARY KEY AUTOINCREMENT,`" + COLUMN_PLANDAY + "` TEXT,`" + COLUMN_EXERCICE + "` TEXT,`" + COLUMN_SETCOUNT + "` INTEGER);");
        ...
        db.execSQL("CREATE TABLE if not exists `" + TABLE_TRAINSET + "` (`" + COLUMN_ID + "` INTEGER PRIMARY KEY AUTOINCREMENT,`" + COLUMN_TRAINEXERCICE + "` INTEGER,`" + COLUMN_SETNR + "` INTEGER,`" + COLUMN_WEIGHT + "` NUMERIC,`" + COLUMN_REPEATS + "` NUMERIC);");
    }
