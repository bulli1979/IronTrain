...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_EXERCICENAME = "exercicename";
    public static final String COLUMN_EXERCICEDESCRIPTION = "exercicedescription";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE if not exists `" + TABLE_TRAINEXERCICE + "` (`" + COLUMN_ID + "` TEXT PRIMARY KEY ,`" + COLUMN_PLANDAYEXERCICE + "` TEXT,`" + COLUMN_TRAIN + "` TEXT,`" + COLUMN_EXERCICENAME + "` TEXT,`" + COLUMN_EXERCICEDESCRIPTION + "` TEXT);");
